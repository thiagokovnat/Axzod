...
```
async get<T>(url: string, schema: z.ZodType<T>, headers = {}): Promise<T>
async delete<T>(url: string, schema: z.ZodType<T>, headers = {}): Promise<T>
async post<T>(url: string, schema: z.ZodType<T>, body?: any, headers = {}): Promise<T>
async put<T>(url: string, schema: z.ZodType<T>, body?: any, headers = {}): Promise<T>
